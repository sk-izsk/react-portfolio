...
export const projects: Project[] = [
  {
    id: 1,
    name: "SwiftConnect, Montreal - Software Engineer",
    image: "", // Add image URL if available
    description:
      "I am working in a team that primarily deals with frontend technologies, such as React, Typescript, React i18n, Antd, React Query, localization Etc. Also maintain private NPM libraries.",
    tags: ["React", "Typescript", "React i18n", "Antd", "React Query"],
    source_code: "", // Add source code URL if available
    demo: "",
  },
  {
    id: 2,
    name: "NEXT Portfolio - Personal",
    image: "", // Add image URL if available
    description:
    ...
    tags: ["NEXT", "React", "Typescript", "Yup", "Axios", "Tailwind CSS"],
    source_code: "https://izsk.vercel.app", // Add source code URL if available
    demo: "https://youtu.be/nt4rB9gwIHg",
  },
  {
    id: 3,
    name: "Hatchways, Toronto — FullStack Developer(Co-Op)",
    image: "", // Add image URL if available
    description:
    ...
    source_code: "https://github.com/sk-izsk/team-pumpkin", // Add source code URL if available
    demo: "",
  },
  {
    id: 4,
    name: "Guiker Inc, Montreal — Software Developer",
    description:
  ...
  {
    id: 5,
    name: "desMoments-ecommerce (Freelancing)",
    description:
  ...
  {
    id: 8,
    name: "Portfolio-Backend — Personal",
    description:
  ...
  {
    id: 9,
    name: "Facebook Clone (Desktop View)",
    description:
  ...
  {
    id: 12,
    name: "Airbnb Clone (Desktop View)",
    description:
